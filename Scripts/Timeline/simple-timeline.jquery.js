            ...
            if (newDate === $this.data("date")) {
              ...
              $('.eventButton').each(function() {
                if('d' + newDate  ===  $(this).attr('id')) {
                  $(this).children( ".blob" ).animate({"backgroundColor": "#FF0000"}, 200);
                }
          ...
          $('.eventButton').on({
            ...
            mouseenter: function(e) {
              ...
              self.options.content.each(function() {
                ...
                if (dateId === $this.data("date")) {
                  ...
                  blob.animate({backgroundColor: "#FF0000"}, 300);
            ...
            mouseleave: function(e) {
              ...
              blob.animate({backgroundColor: "#fefefe" }, 200);
                ...
                blob.animate({backgroundColor: "#FF0000"}, 200);
              }
            },
            ...
            click: function(e) {
              ...
              blob.css({backgroundColor: "#FF0000" });
